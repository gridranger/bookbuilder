...
class TestEpubGenerator(TestCase):
    def setUp(self):
        ...
        html_content = {"Part 1": {"chapter 1": "<h1>My first chapter</h1>\n\n<p>Lorem ipsum...</p>\n",
    ...
    def test__generate_nav_points(self):
        ...
        <navLabel><text>Part 1</text></navLabel><content src=""/>
    ...
    <navPoint id="Part 2" playOrder="3">
        <navLabel><text>Part 2</text></navLabel><content src=""/>
    ...
    def test__create_content_page(self):
        self.fail()
